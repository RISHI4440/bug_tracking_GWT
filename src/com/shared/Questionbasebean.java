...
public class Questionbasebean implements Serializable {
    ...
    private Collection<Loginbean> loginCollection;

    public Questionbasebean() {
    }

    public Questionbasebean(Integer questionid) {
        this.questionid = questionid;
    }

    public Questionbasebean(Integer questionid, String questiondetail) {
        this.questionid = questionid;
    ...
    @XmlTransient
    public Collection<Loginbean> getLoginCollection() {
        return loginCollection;
    }

    public void setLoginCollection(Collection<Loginbean> loginCollection) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Questionbasebean)) {
            return false;
        }
        Questionbasebean other = (Questionbasebean) object;
