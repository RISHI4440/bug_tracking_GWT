...
public class Loginauditbean implements Serializable {
    ...
    public Loginauditbean(Integer loginaid) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Loginauditbean)) {
            return false;
        }
        Loginauditbean other = (Loginauditbean) object;
